...
const Navbar = () => {
    ...
    return (
        <div className={`${isTrue ? "bg-gray-800 h-[9vh] fixed opacity-80 top-0 w-full transition duration-500" : 'pt-5 container max-w-[1440px] mx-auto'}`}>
            <div className={`${isTrue ? 'fixed bg-gray-800 w-full top-0  right-0 left-0' : ''} `}>
                <nav className={` ${isTrue ? 'fixed bg-gray-800 z-50 max-w-[1440px]  w-full mx-auto py-3 top-0 right-0 left-0' : 'container mx-auto bg-white rounded-3xl py-3'} overflow-hidden flex justify-between items-center px-10  transition duration-500`}>
                    ...
                    <div className={`flex justify-between gap-x-14 transition duration-500 ${isTrue ? '' : 'translate-x-[340px]'}`}>
                        <div className='flex gap-5 items-center'>
                            ...
                            <div className={`${isTrue ? '' : 'translate-x-80,p-0'} transition duration-500`}><Button btnText={'Combine'}></Button></div>
                        </div>
